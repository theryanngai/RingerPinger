...
ActiveRecord::Schema.define(version: 20141212013004) do
  ...
  add_index "eventusers", ["user_id", "event_id"], name: "index_eventusers_on_user_id_and_event_id", unique: true, using: :btree
